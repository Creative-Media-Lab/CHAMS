...
<?php
    ...
    $sql = "SELECT *
            ...
            WHERE p.ProjectMember = l.ProfileID AND P.DepartmentID='8'";
...
<html lang="en">
    ...
    <div class="main-wrapper">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Projects (STS)</li>
								</ul>
							</div>
        ...
        <form action="addprojectssts.php" method="post">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <option>Select Team</option>
                            <?php
                            $sql = mysqli_query($connection, "SELECT * From profile where DepartmentID = '8'");
