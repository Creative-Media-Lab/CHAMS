        ...
        <div class="main-wrapper">
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
					...
					<!-- Search Filter -->
					<form action="searchprofilehr.php" method="get">
					<div class="row filter-row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="form-group form-focus">
								<input type="text" name="searchname" class="form-control floating" onkeypress="return AvoidSpace(event)">
...
$sql ="SELECT *
		 FROM profile
		 WHERE DepartmentID = '2' AND Username LIKE '%".$searchname."%'";
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input class="form-control" type="text" onkeypress="return AvoidSpace(event)" name="Username">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<label class="col-form-label">NRIC <span class="text-danger">*</label>
