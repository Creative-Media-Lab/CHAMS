...
<?php
    ...
    $sql = "SELECT *
            ...
            WHERE p.ProjectMember = l.ProfileID AND P.DepartmentID='4'";
...
<html lang="en">
    ...
    <body>
       ...
       <div class="main-wrapper">
						...
						<div class="row align-items-center">
							<div class="col">
								...
								<ul class="breadcrumb">
									...
									<li class="breadcrumb-item active">Projects (Quality/ISO)</li>
								</ul>
							</div>
        ...
        <form action="addprojectsquality.php" method="post">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <option>Select Team</option>
                            <?php
                            $sql = mysqli_query($connection, "SELECT * From profile where DepartmentID = '4'");
