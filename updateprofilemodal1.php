...
include "connection.php";
  ...
  if(ISSET($_POST['submit3']))
  {
   ...
   $result= mysqli_query($connection, "UPDATE profile SET FirstName = '$FirstName', LastName = '$LastName',  Username = '$Username', Email = '$Email' WHERE ProfileID = '$ProfileID'") or die(mysqli_error($connection));
