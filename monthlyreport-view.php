	...
	$MonthlyReportID =$_GET['MonthlyReportID'];
		...
		while($row = mysqli_fetch_array($result))
		{
					...
					echo'<div class="row">';
							...
							echo'<div class="card">';
								echo'<div class="card-body">';
									echo'<div class="project-title">';
										echo'<h5 class="card-title">'.$row['MonthlyReportName'].'</h5>';
						...
						echo'</div>';
							echo'<div class="card">';
								echo'<div class="card-body">';
									echo'<div class="project-title">';
										echo'<h5 class="card-title">'.$row['Month'].'</h5>';
									echo'</div>';
									echo'<p> Good </p>';
							...
							echo'<div class="card">';
								echo'<div class="card-body">';
				                    echo'<h5 class="card-title m-b-20">Uploaded files</h5>';
									echo'<div class="row">';
										echo'<div class="col-md-3 col-sm-4 col-lg-4 col-xl-3">';
											
													echo'<a href="downloadmonthlyreport.php?MonthlyReportID='. $row['MonthlyReportID'].'"><span class="glyphicon glyphicon-download"></span>'.basename($row['UploadFile']).'</a>';
										echo'</div>';
					...
					echo'	<div class="col-lg-4 col-xl-3">';
							echo'<div class="card">';
								echo'<div class="card-body">';
									echo'<h6 class="card-title m-b-15">Monthly Report details</h6>';
									echo'<table class="table table-striped table-border">';
										echo'<tbody>';

											echo'<tr>';
												echo'<td>Uploaded:</td>';
												echo'<td class="text-right">'.$row["UploadTime"].'</td>';
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form action="updatemonthlyreport.php" method="post" enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label>Report Name</label>
												<input type="hidden" name="MonthlyReportID" value="<?php echo $row['MonthlyReportID']?>"/>
												<input class="form-control" placeholder="<?php echo $row['MonthlyReportName']; ?>" value="<?php echo $row['MonthlyReportName']; ?>" type="text" readonly>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input class="form-control" placeholder="<?php echo $row['StartDate']; ?>" value = "<?php echo $row['StartDate']; ?>" type="date" name="StartDate">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
												<label>End Date</label>
												<input class="form-control" placeholder="<?php echo $row['EndDate']; ?>" value ="<?php echo $row['EndDate']; ?>" type="date" name="EndDate">
									...
									<div class="form-group">
										<label>Comment</label>
										<textarea rows="4" class="form-control" name="Comment" value="<?php echo $row['Comment']; ?>"></textarea>
									</div>
									<div class="form-group">
										<label>Upload Files</label>
										<input class="form-control" type="file" name="UploadFile" accept=".doc,.docx,.pdf,.txt,.rtf">
									</div>
