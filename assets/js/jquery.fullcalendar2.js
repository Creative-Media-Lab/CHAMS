    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                ...
                .append("<option value='bg-success'>Not Important</option>")
                .append("<option value='bg-purple'>Event</option>")
                // .append("<option value='bg-primary'>Primary</option>")
                .append("<option value='bg-pink'>Shooting</option>")
                .append("<option value='bg-info'>Note</option>")
               // .append("<option value='bg-inverse'>Inverse</option>")
                .append("<option value='bg-orange'>Posting</option>")
